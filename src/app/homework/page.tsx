...
export const metadata: Metadata = {
  title: '마비노기 모바일 숙제 트래커',
  description: '마비노기 모바일 일일 숙제와 주간 숙제를 체크리스트로 관리하세요. 놓치는 보상 없이 효율적으로 플레이할 수 있습니다.',
  keywords: ['마비노기 모바일 숙제', '마비노기 모바일 일일 숙제', '일일 퀘스트', '주간 퀘스트', '체크리스트'],
  openGraph: {
    title: '마비노기 모바일 숙제 트래커 | Mabi Life',
    description: '마비노기 모바일 일일/주간 숙제를 체크리스트로 관리하세요. 놓치는 보상 없이 효율적으로!',
  ...
  twitter: {
    ...
    title: '마비노기 모바일 숙제 트래커 | Mabi Life',
    description: '마비노기 모바일 일일/주간 숙제를 체크리스트로 관리하세요.',
