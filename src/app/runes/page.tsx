...
export const metadata: Metadata = {
  title: '마비노기 모바일 직업별 추천 룬',
  description: '마비노기 모바일 직업별 최적의 룬 조합을 확인하세요. 전사, 궁수, 마법사 등 모든 직업의 추천 룬 세팅을 제공합니다.',
  keywords: ['마비노기 모바일 룬', '마비노기 모바일 룬 추천', '직업별 룬 추천', '룬 세팅', '전투력 올리기'],
  openGraph: {
    title: '마비노기 모바일 직업별 추천 룬 | Mabi Life',
    description: '마비노기 모바일 직업별 최적의 룬 조합을 확인하세요. 모든 직업의 추천 룬 세팅.',
    url: `${SITE_URL}/runes`,
    type: 'website',
